...
import de.hybris.training.service.impl.DefaultTrainingcommerceservicesService;
 ...
 */
@IntegrationTest
public class DefaultTrainingcommerceservicesServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "trainingcommerceservicesPlatformLogo";

		// when
		final String logoUrl = trainingcommerceservicesService.getHybrisLogoUrl(logoCode);
