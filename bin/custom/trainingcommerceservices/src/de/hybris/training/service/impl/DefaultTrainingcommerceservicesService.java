...
public class DefaultTrainingcommerceservicesService implements TrainingcommerceservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingcommerceservicesService.class);
	...
	{
		return DefaultTrainingcommerceservicesService.class.getResourceAsStream("/trainingcommerceservices/sap-hybris-platform.png");
	}
